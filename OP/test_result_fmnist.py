...
# output = np.load('./fmnist_ensemble_100_output.npy')
# labels = np.load('./fmnist_test_labels.npy')
# labels_onehot = np.load('./fmnist_test_labels_onehot.npy')
# with open('./fmnist_test_data_class_to_idx.txt', 'r') as f:
...
# np.save('./fmnist_all_p_star_SED.npy', pred_mean)
# np.save('./fmnist_all_p_star_L1.npy', all_p_star_L1)
# np.save('./fmnist_all_p_star_KLD.npy', all_p_star_KLD)

# np.save('./fmnist_predictions_SED.npy', Y_pred)
# np.save('./fmnist_predictions_L1.npy', predictions_L1)
# np.save('./fmnist_predictions_KLD.npy', predictions_KLD)
...
# all_p_star_SED = np.load('./fmnist_all_p_star_SED.npy')
# all_p_star_L1 = np.load('./fmnist_all_p_star_L1.npy')
# all_p_star_KLD = np.load('./fmnist_all_p_star_KLD.npy')
# predictions_SED = np.load('./fmnist_predictions_SED.npy')
# predictions_L1 = np.load('./fmnist_predictions_L1.npy')
# predictions_KLD = np.load('./fmnist_predictions_KLD.npy')
...
# output shape ([100, 10000, 10])
output = np.load('./iukm/fmnist_ensemble_100_output_best.npy')
labels = np.load('./iukm/fmnist_test_labels.npy')
with open('./iukm/fmnist_test_data_class_to_idx.txt', 'r') as f:
        class_to_idx = json.load(f)
n_class = len(class_to_idx)
...
all_precise_results[0] = np.load('./iukm/fmnist_predictions_SED.npy')
all_precise_results[1] = np.load('./iukm/fmnist_predictions_L1.npy')
all_precise_results[2] = np.load('./iukm/fmnist_predictions_KLD.npy')
