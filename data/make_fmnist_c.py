...
####
folder_path = root + 'data/FMNIST-10-C/gaussian_noise_1_6/'
os.makedirs(folder_path, exist_ok=True)
####

# Only test data
data_clean = dset.FashionMNIST('./data', train=False)
...
for method_name in d.keys():
    ...
    np.save(root + 'data/FMNIST-10-C/gaussian_noise_1_6/' + d[method_name].__name__ + '_clean_test.npy', np.array(data_clean_list).astype(np.uint8))
    np.save(root + 'data/FMNIST-10-C/gaussian_noise_1_6/' + d[method_name].__name__ + '_c_test.npy', np.array(data_c).astype(np.uint8))

    # This replaces not appends
    np.save(root + 'data/FMNIST-10-C/gaussian_noise_1_6/label_test.npy',
            np.array(labels).astype(np.uint8))


# # # Only train data

data_clean = dset.FashionMNIST('./data', train=True)
...
for method_name in d.keys():
    ...
    np.save(root + 'data/FMNIST-10-C/gaussian_noise_1_6/' + d[method_name].__name__ + '_clean_train.npy', np.array(data_clean_list).astype(np.uint8))
    np.save(root + 'data/FMNIST-10-C/gaussian_noise_1_6/' + d[method_name].__name__ + '_c_train.npy', np.array(data_c).astype(np.uint8))

    # This replaces not appends
    np.save(root + 'data/FMNIST-10-C/gaussian_noise_1_6/label_train.npy',
        np.array(labels).astype(np.uint8))