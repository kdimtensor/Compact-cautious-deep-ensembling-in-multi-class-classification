...
from leaf10_c import LEAFC, LEAFCLEAN
...
def main():
    ...
    # model = torch.nn.DataParallel(resnet.__dict__[args.arch](num_classes = 39))
    ...
    if args.mode == 'train':
        ...
        for fold in range(k_folds):
            ...
            args.save_dir = root_dir + f'/data/{data_name}/gaussian_{train_type}_fold/'
            ...
            for epoch in range(args.start_epoch, args.epochs):
                ...
                if is_best_noise:
                    save_checkpoint(
                        ...
                        filename=os.path.join(
                            args.save_dir, f'bayesian_{args.arch}_cifar_noise_fold_{fold}.pth'))
                ...
                if is_best_clean:
                    save_checkpoint(
                        ...
                        is_best_clean,
                        filename=os.path.join(
                            args.save_dir, f'bayesian_{args.arch}_cifar_clean_fold_{fold}.pth'))
