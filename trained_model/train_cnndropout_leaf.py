...
from models.resnet_dropout import ResNet18Dropout,BasicBlock, ResNetDropout, ResNetDropout_leaf
...
def main():
    ...
    if args.mode == 'train':
        ...
        args.save_dir = root_dir + f'/data/{data_name}/gaussian_{train_type}_fold/Drop_out/'
        # save_dir = root_dir + f'/data/{data_name}/gaussian_{train_type}_fold/'
        ...
        for fold in range(k_folds):
            ...
            checkpoint_file = f'{save_dir}model/bayesian_{args.model_name}_{train_type}_fold_{fold}.pth'
