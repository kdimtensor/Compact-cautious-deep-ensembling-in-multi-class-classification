...
def main():
    ...
    args.save_dir = data_path + f'gaussian_{train_type}_fold/Bayes/'
    ...
    if args.mode == 'train':
        ...
        train_data = CIFAR10C(
        root= data_path + 'gaussian_noise_6/',
        train=True,
        ...
        for fold in range(k_folds):
            ...
            train_ids = np.load(data_path + f'k_fold_id/train_ids_fold_{fold}.npy')
            test_ids = np.load(data_path + f'k_fold_id/test_ids_fold_{fold}.npy')
        ...
        for fold in range(k_folds):
            ...
            checkpoint_file = f'{args.save_dir}model/bayesian_{args.arch}_cifar_{train_type}_fold_{fold}.pth'
            if torch.cuda.is_available():
            ...
            evaluate(args, model, val_loader_c, fold, 'c',args.save_dir)
            evaluate(args, model, val_loader_clean, fold, 'clean',args.save_dir)
